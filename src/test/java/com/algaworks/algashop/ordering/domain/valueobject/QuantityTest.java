...
import static com.algaworks.algashop.ordering.domain.exception.ErrorMessages.VALIDATION_ERROR_MESSAGE_NEGATIVE_QUANTITY;
...
class QuantityTest {
    ...
    void givenZeroConstant_shouldReturnZeroQuantity() {
        assertAll(
                ...
                () -> assertThat(Quantity.ZERO.toString()).isEqualTo("0")
        );
    }
    ...
    void testZeroConstantIsImmutable() {
        ...
        assertThat(zero1.value()).isEqualTo(0);
        assertThat(zero2.value()).isEqualTo(0);
    }
    ...
    void givenQuantity_shouldReturnStringRepresentation() {
        ...
        assertThat(quantity.toString()).isEqualTo("123");
    }
    ...
    void testBusinessScenarioAddQuantities() {
        ...
        Quantity removedItems = new Quantity(1); // Remove 1 item (adicionando negativo?)
    ...
    void givenBoundaryValues_shouldHandleCorrectly() {
        assertAll(
                () -> {
                    ...
                    assertThat(min.value()).isEqualTo(0);
                },
                () -> {
    ...
    void testCompareToContract() {
        ...
        assertThat(smaller.compareTo(middle) < 0).isTrue();
        assertThat(middle.compareTo(larger) < 0).isTrue();
        assertThat(smaller.compareTo(larger) < 0).isTrue();
    }
}