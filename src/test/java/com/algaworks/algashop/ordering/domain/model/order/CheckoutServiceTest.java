...
class CheckoutServiceTest {
    ...
    void givenValidShoppingCart_whenCheckout_shouldReturnPlacedOrderAndEmptyShoppingCart() {
        ...
        shoppingCart.addItem(ProductTestDataBuilder.aProduct().id(new ProductId()).build(), new Quantity(1));
    ...
    void givenShoppingCartWithUnavailableItems_whenCheckout_shouldNotModifyShoppingCartState() {
        ...
        Product productAlt = ProductTestDataBuilder.aProduct().id(new ProductId()).build();
        shoppingCart.addItem(productAlt, new Quantity(1));

        Product productAltUnavailable = ProductTestDataBuilder.aProduct().id(productAlt.id()).inStock(false).build();
