...
public class ErrorMessages {
    ...
    public static final String ERROR_CUSTOMER_EMAIL_IS_IN_USE = "customer email '%s' is already in use.";
    public static final String ERROR_SHOPPING_CART_CAN_NOT_PROCEED_TO_CHECKOUT = "shopping cart '%s' can not proceed to checkout.";
