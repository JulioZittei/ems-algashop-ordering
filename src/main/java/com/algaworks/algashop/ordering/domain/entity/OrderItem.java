...
public class OrderItem {
    ...
    private static Money calculateTotalAmount(final Money price, final Quantity quantity) {
        BigDecimal orderItemTotalAmount = price.value()
                .multiply(BigDecimal.valueOf(quantity.value()));

        return new Money(orderItemTotalAmount);
    }
